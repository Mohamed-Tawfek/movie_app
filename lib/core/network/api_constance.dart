class ApiConstance {
  ...
  static String createMovieDetailsUrl({required int id})=>'${baseUrl}movie/$id?api_key=$apiKey';
  static String createMovieRecommendationsUrl({required int id})=>'${baseUrl}movie/$id/recommendations?api_key=$apiKey';
 }
