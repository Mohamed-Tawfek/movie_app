...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocProvider(
        create: (_) =>
        MovieDetailsBloc(getMovieDetails: sl(), getMovieRecommendations: sl())
          ..add(GetMovieDetailsEvent(id))..add(
            GetRecommendationDetailsEvent(id)),
...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
       if([state.movieRecommendations,state.movieDetails].contains(null)){
         return Container();
       }
       else{
        return CustomScrollView(
          ...
          slivers: [
            ...
            SliverPadding(
              ...
              sliver: _showRecommendations(recommendations: state.movieRecommendations!),
            ),
          ],
  ...
  Widget _showRecommendations({required List<MovieRecommendation> recommendations }) {
    ...
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
          ...
          return FadeInUp(
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (_)=>MovieDetailScreen(id:recommendation.id)));
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: ApiConstance.createImageUrl(
                      path: recommendation.backdropPath),
